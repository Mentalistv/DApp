...
int main(int argc, char* argv[]){
    ...
    for(int t=0; t<NUMBER_OF_REQUESTS; t++){
        ...
        NewsType final_results = TRUE;
        int count_final_results = 0;
        ...
        for(auto i: fact_checkers){
            ...
            if(temp_res == news_to_be_checked->news_type){
        ...
        NewsType result_after_voting = (voters_result/sum_credibility)>0.5 ? TRUE : FAKE;
